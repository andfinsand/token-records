...
class Nft:
    ...
    # @classmethod
    # def get_mint(cls, data):
    #     query = "SELECT mint_address FROM nfts JOIN users ON users.id = nfts.user_id WHERE nfts.id = %(id)s";
    #     result = connectToMySQL(db_name).query_db(query, data)
    #     return cls(result[0])
